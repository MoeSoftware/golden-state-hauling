...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      details: 'Mon-Sat: 7am-7pm | Sunday: Closed',
      action: null,
      actionText: null
    },
    {
      ...
      title: 'Service Area',
      details: 'Greater metropolitan area and surrounding counties',
      action: null,
      actionText: null
    },
    {
      ...
      title: 'Email Us',
      details: 'info@goldenhauling.com',
      action: 'mailto:info@goldenhauling.com',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Ready to clear out your space or need equipment transported? We're just a phone call away.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg mt-12 p-8 text-center">
          <h3 className="text-2xl font-bold text-blue-900 mb-4">Need a Quote Fast?</h3>
          <p className="text-lg text-gray-700 mb-6">
            We pride ourselves on quick responses and competitive pricing. Give us a call today!
          </p>
          <a 
