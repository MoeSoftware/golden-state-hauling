  ...
  const services: ServiceType[] = [
    {
      ...
      description:
        "Comprehensive cleanout services for homes, businesses, and properties.",
    ...
    },
    {
      ...
      description:
        "12′ dump trailer – up to ~7,000 lbs payload capacity for your equipment needs.",
    ...
    },
    {
      ...
      description:
        "Delivery and removal of various materials for your projects.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            From junk removal to equipment transport, we offer a wide range of
            services to meet your hauling and cleanout needs.
          </p>
        </div>
