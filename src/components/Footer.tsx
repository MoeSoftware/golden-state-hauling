      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-1">
            ...
            <p className="text-blue-200 mb-4">
              Professional hauling, junk removal, and equipment transport
              services you can count on.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-blue-200 hover:text-amber-500 transition-colors duration-300"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-blue-200">
                ...
                goldenstatehaulingandcleaning@gmail.com
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-blue-800 pt-8 text-center">
          <p className="text-blue-300 text-sm">
            © {currentYear} Golden State Hauling & Cleaning Services. All rights
            reserved.
          </p>
        </div>
      </div>
